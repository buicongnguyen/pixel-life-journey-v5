...
- **Age** — advances with every consequential action. Crossing a stage's
...
A partner may pass in later life at an individually varied age. The timing is not
determined by gender. The loss remains a real story beat: grief affects wellbeing, the
partner leaves the room, and the life story records the relationship.
